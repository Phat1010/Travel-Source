...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 10, 2021 lúc 06:20 PM
...
('0', 'S3', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Một Mình', '2021-12-08', 'cd75751455249e7ac735.jpg', '', '', '', ''),
('0', 'S1', 'đẹp lăm nha ae', '4', 'minh hoạ', 'Gia đình(Thanh thiếu niên)', '2021-12-02', '', '', '', '', ''),
('0', 'S17', 'đẹp lăm nha ae', '5', 'alo alo', 'Bạn bè', '2021-12-10', '', '', '', '', ''),
('0', 'S23', 'alo alo', '3', 'âcscasc', 'Một Mình', '2021-12-10', '', '', '', '', ''),
('10', 'S1', 'đẹp lăm nha ae', '5', 'âcscasc', 'Gia đình(Thanh thiếu niên)', '2021-12-10', '141a5231dcd5178b4ec4.jpg', '', '', '', ''),
('10', 'S1', 'đẹp lăm nha ae', '5', 'âcscasc', 'Doanh nghiệp', '2021-12-10', 'cd75751455249e7ac735.jpg', '', '', '', ''),
('10', 'S17', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Gia đình(Trẻ nhỏ)', '2021-12-10', 'cd75751455249e7ac735.jpg', '', '', '', ''),
('10', 'S17', 'đẹp lăm nha ae', '', 'minh hoạ', 'Một Mình', '', '', '3', '', '4', '2'),
('10', 'S1', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Gia đình(Trẻ nhỏ)', '2021-12-10', '', '', '', '', ''),
('10', 'S27', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Gia đình(Thanh thiếu niên)', '2021-12-10', '', '', '', '', ''),
('10', 'S17', 'đẹp lăm nha ae', '', 'minh hoạ', 'Một Mình', '', '', '3', '', '2', '5'),
('10', 'S17', 'test', '', 'minh hoạ', 'Một Mình', '', '', '3', '', '2', '5'),
('10', 'S17', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Một Mình', '', '', '3', '', '5', '4'),
('10', 'S15', 'đẹp lăm nha ae', '4', 'minh hoạ', 'Một Mình', '', '4b2afd81ee74252a7c65.jpg', '2', '', '4', '2'),
('10', 'S15', 'đẹp lăm nha ae', '4', 'minh hoạ', 'Một Mình', '', '', '2', '', '2', '3'),
('10', 'S15', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Một Mình', '', 'cd75751455249e7ac735.jpg', '1', '', '3', '3'),
('10', 'S15', 'đẹp lăm nha ae', '5', 'minh hoạ', 'Một Mình', '', 'cd75751455249e7ac735.jpg', '2', '', '5', '2'),
('10', 'S17', 'đẹp lăm nha ae', '', 'minh hoạ', 'Một Mình', '', '', '3', '', '2', '4'),
('10', 'S15', 'test', '3', 'minh hoạ', 'Một Mình', '', 'cd75751455249e7ac735.jpg', '2', '4', '4', '3');
...
('S15', 'Khách sạn Mường Thanh Quy Nhơn', 'muong_thanh_1.png', '02 Nguyễn Huệ, Phường Lê Lợi, Quy Nhơn, Bình Định', 'Đến với Mường Thanh Quy Nhơn, quý khách sẽ được tận hưởng những phút giây thư giãn thoải mái khi ngồi thưởng thức tách cà phê bên cạnh hồ bơi được thiết kế đẹp mắt, và luôn được đội ngũ nhân viên của chúng tôi phục vụ tận tình, chu đáo, mang đến cho quý khách các dịch vụ hạng nhất.', NULL, NULL, '350000', 'P4', 'H1', 'Img14', '', '', '1', '0', '', '', '', ''),
('S16', 'FLC Luxury Hotel Quy Nhơn ', 'flc_luxury_2.png', 'Khu 4, Nhơn Lý - Bãi biển Cát Tiến, xã Nhơn Lý, tỉnh Bình Định', 'Cách sân bay Phù Cát 40 phút và để đi đến trung tâm thành phố chỉ với 15 phút lái xe, tọa lạc tại bãi biển thiên đường ở vị trí trung tâm của Quần thể FLC Quy Nhơn - nơi có thể ngắm bình minh đẹp nhất Việt Nam, FLC Luxury Hotel Quy Nhơn đem lại một kì nghỉ trọn vẹn cho du khách.', NULL, NULL, '560000', 'P4', 'H1', 'Img15', '', '', '1', '0', '', '', '', ''),
('S17', 'Fraser Suites Hanoi', 'ha_noi_1.png', '51 Xuân Diệu, Phường Quảng An, Quận Tây Hồ, Hà Nội, Việt Nam', 'Khách Sạn Fraser Suites là khách sạn nằm ở đường Xuân Diệu Hà Nội, cách sân bay Nội Bài 30 phút chạy xe, cách trung tâm thành phố 15 phút, là một nơi nghỉ chân được rất nhiều du khách trong và ngoài nước lựa chọn.', NULL, NULL, '2800000', 'P1', 'H1', 'Img16', '', '', '1', '0', '', '', '', ''),
('S18', 'Khách sạn Bunny', 'hotel_sai_gon_1.png', '47 Nguyễn Trãi, Phường Bến Thành, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh, Việt Nam', 'Được xây dựng tại vị trí hạng nhất của thành phố Hồ Chí Minh, chỉ cần bước ra bên ngoài Cat Hotel 3, bạn có thể dễ dàng tiếp cận các điểm đến hấp dẫn ở thành phố này. Khách sạn đem đến hàng loạt các dịch vụ và tiện nghi để đem đến kì nghỉ thoải mái và dễ chịu. Với đội ngũ nhân viên luôn phục vụ tận tình, bạn sẽ luôn được chào đón tại Cat Hotel 3. Mỗi phòng nghỉ đều được trang bị nội thất sang trọng và các tiện nghi dễ sử dụng.', NULL, NULL, '320855', 'P7', 'H1', 'Img17', '', '', '1', '0', '', '', '', ''),
...
('S6', 'Khách sạn Hải Âu', 'anh6.png', '489, An Dương Vương, P. Nguyễn Văn Cừ, Thành phố Quy Nhơn, T. Bình Định', 'Khách sạn Hải Âu Quy Nhơn có thiết kế theo kiến trúc Châu Âu hiện đại, gồm 170 phòng, các phòng được trang bị điều hòa, báo hàng ngày, bàn, máy sấy tóc. \r\nCác dịch vụ khách sạn gồm dịch vụ phòng 24 giờ, cửa hàng, quầy bar, giặt là, và nhà hàng. Tiện nghi giải trí và thư giãn bao gồm massage, bể sục, phòng tập, tắm hơi, spa, thể thao dưới nước (có động cơ), sân quần vợt, hồ bơi. ', '6h30', '23h00', '320000', 'P4', 'H1', 'Img6', '', '', '1', '0', '', '', '', ''),
