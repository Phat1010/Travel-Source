...
-- Thời gian đã tạo: Th10 17, 2021 lúc 03:57 PM
...
INSERT INTO `rate` (`userid`, `idservice`, `comment`, `ratestar`) VALUES
('7', 'S14', 'Kha la ngon', '3'),
('1', 'S1', 'Kha la vui', '3'),
('7', 'S1', 'VUi that', '3'),
('7', 'S21', 'Ban nu xinh qua za', '3'),
('7', 'S27', 'Nhà hàng tuyệt lắm', '5'),
('7', 'S28', 'Tot', '5'),
('1', 'S27', 'Món ăn ok', '3'),
('1', 'S12', 'Oke', '5'),
('1', 'S27', 'Dở', '1'),
...
INSERT INTO `service` (`idservice`, `servicename`, `avatar`, `address`, `description`, `openn`, `closee`, `price`, `proviceid`, `idtype`, `idimage`, `prices`, `typefood`, `pool`, `park`, `entertain`) VALUES
...
('S26', 'Towa - Japanese Cuisine\n', 'jp_1.png', 'Tầng 28, 92-94 Nam Kì Khởi Nghĩa Saigon Centre, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh', 'Đối với chúng tôi, đánh giá cao nghệ thuật ẩm thực không chỉ đơn thuần là có một món ăn, mà còn là một hành trình tương tác. Bắt đầu từ những nguyên liệu tinh khiết và tốt nhất, các loại hải sản cao cấp của TOWA hầu hết đến từ khu chợ nổi tiếng Toyosu ở Tokyo.', '8:00', '23:00', '3', 'P7', 'H2', 'Img26', '2.500.000', 'Món Âu', '', '', ''),
('S27', 'The Rhythms Restaurant', 'trs_1.png', 'Tầng 7, 33 - 35 Hàng Dầu, Phường Lý Thái Tổ, Quận Hoàn Kiếm, Hà Nội', 'Thành lập năm 2019 và là một trong những thương hiệu hàng đầu của La Sinfonía Hotels and Resorts Group, nhà hàng The Rhythms lấy cảm hứng từ những đặc tính cơ bản của âm nhạc, ngân lên một bản giao hưởng của ẩm thực Việt Nam chính hiệu, nhấn nhá với những nét kiến trúc đương đại, tinh tế đến từng chi tiết.', '7:00', '22:00', '3', 'P1', 'H2', 'Img27', '2.450.000', 'Món Âu', '', '', ''),
